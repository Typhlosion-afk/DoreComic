...
import com.example.dorecomic.utilities.READ_FILE_PERMISSION_CODE
import java.io.File
...
class LaunchActivity : AppCompatActivity() {
    ...
    private fun setRootFile(){
        ...
        val rootPath : String = sharedPrefs.getString("root_file", "").toString()
        if(rootPath == ""){
    ...
    private fun checkPermission(){
        if(ContextCompat.checkSelfPermission(this@LaunchActivity, Manifest.permission.READ_EXTERNAL_STORAGE
            ) == PackageManager.PERMISSION_DENIED){
            ActivityCompat
                .requestPermissions(this@LaunchActivity, arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE), READ_FILE_PERMISSION_CODE)
        }else{
            onPermissionGranted()
        }
    }
